{
	...
	Html.p('Within the root directory of a stock install, you will find two folders. One named "_core", this contains core NWT classes and libraries, and one named "example". The "example" folder contains a fully functioning application.') + 
